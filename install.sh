...
run_exec "$SETUP_INSTALL/install-tailscale.sh"
run_exec "$SETUP_INSTALL/install-git-crypt.sh"
run_exec "$SETUP_INSTALL/install-jiratui.sh"
run_exec "$SETUP_INSTALL/install-zig.sh"
